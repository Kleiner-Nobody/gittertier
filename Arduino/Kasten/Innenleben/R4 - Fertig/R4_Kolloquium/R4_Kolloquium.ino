/**
 * ============================================================================================
 * GITTERTIER PRO - INDUSTRIAL MASTER HUB v18.7 (STABLE DOME & SMART PARSER)
 * ============================================================================================
...
#define DOME_LEDS 16 // <--- HIER DEINE GEZÄHLTEN LEDs EINTRAGEN (z.B. 24 oder 32)!
...
int currentSpeedPWM = 50; // Standard Motor PWM
...
// ============================================================================================
// DOME ANIMATION LOGIK (Non-Blocking & Interrupt-Safe)
// ============================================================================================
...
void updateDome() {
    ...
    static DomeEffect lastEffect = OFF; // Speichert den vorherigen Zustand

    // Not-Aus überschreibt alles
    DomeEffect actualEffect = emergencyStopActive ? SOLID_RED : currentDomeEffect;

    // Reset Timer, wenn der Effekt gewechselt wurde, für sofortige Reaktion
    if (actualEffect != lastEffect) {
        lastUpdate = 0;
    }
    ...
    switch (actualEffect) {
        ...
        case SOLID_RED:
            // Wird NUR einmal aufgerufen beim Wechsel in diesen Zustand (verhindert Blockade)
            if (actualEffect != lastEffect) {
        ...
        case OFF:
            // Wird NUR einmal aufgerufen beim Ausschalten (verhindert Interrupt-Tod!)
            if (actualEffect != lastEffect) {
                dome.clear();
                dome.show();
            }
    ...
    lastEffect = actualEffect; // Zustand für den nächsten Loop merken
}
