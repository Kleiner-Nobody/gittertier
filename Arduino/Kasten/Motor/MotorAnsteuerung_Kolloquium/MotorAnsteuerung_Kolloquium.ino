...
void ProcessCommand(String command, int data)
{
    ...
    {
        // 1. Ursprüngliche Seite auslesen
        char side = command.charAt(0);
        
        // 2. NEU: Seiten vertauschen für die gekreuzte Lenkung
        if (side == 'L') {
            side = 'R'; 
        } else if (side == 'R') {
            side = 'L';
        ...
        // 3. Befehl ohne den Präfix-Buchstaben extrahieren
    ...
    {
        // Bei Befehlen ohne Präfix (z.B. PWM,150) weiterhin beide Motoren ansteuern
